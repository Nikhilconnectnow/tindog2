...
//           <a href="#contact" className="block px-4 py-2 hover:bg-[#ff3a55]">
//             Contact
//           </a>
//           <a href="#pricing" className="block px-4 py-2 hover:bg-[#ff3a55]">
//             Pricing
//           </a>
//           <a href="#download" className="block px-4 py-2 hover:bg-[#ff3a55]">
//             Download
//           </a>

//           {!isAuthenticated ? (
//             <>
//               <Link to="/login" className="block px-4 py-2 hover:bg-[#ff3a55]">
//                 Login
//               </Link>
//               <Link
//                 to="/signup"
